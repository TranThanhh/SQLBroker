...
namespace SQLDePendency {
    ...
    public partial class ds : global::System.Data.DataSet {
        ...
        public partial class NHANVIEN1DataTable : global::System.Data.TypedTableBase<NHANVIEN1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public NHANVIEN1Row AddNHANVIEN1Row(int MaNV, string HO, string TEN, string PHAI, string DIACHI) {
        ...
        public partial class NHANVIEN1Row : global::System.Data.DataRow {
            ...
            public string PHAI {
                get {
                    return ((string)(this[this.tableNHANVIEN1.PHAIColumn]));
                }
                set {
                    this[this.tableNHANVIEN1.PHAIColumn] = value;
                }
            }
...
namespace SQLDePendency.dsTableAdapters {
    ...
    public partial class NHANVIEN1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[NHANVIEN1] WHERE (([MaNV] = @Original_MaNV) AND ([HO] = @Origi" +
                "nal_HO) AND ([TEN] = @Original_TEN) AND ([PHAI] = @Original_PHAI) AND ([DIACHI] " +
                "= @Original_DIACHI))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[NHANVIEN1] ([MaNV], [HO], [TEN], [PHAI], [DIACHI]) VALUES (@Ma" +
                "NV, @HO, @TEN, @PHAI, @DIACHI);\r\nSELECT MaNV, HO, TEN, PHAI, DIACHI FROM NHANVIE" +
                "N1 WHERE (MaNV = @MaNV)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NHANVIEN1] SET [MaNV] = @MaNV, [HO] = @HO, [TEN] = @TEN, [PHAI] = @PHAI, [DIACHI] = @DIACHI WHERE (([MaNV] = @Original_MaNV) AND ([HO] = @Original_HO) AND ([TEN] = @Original_TEN) AND ([PHAI] = @Original_PHAI) AND ([DIACHI] = @Original_DIACHI));
SELECT MaNV, HO, TEN, PHAI, DIACHI FROM NHANVIEN1 WHERE (MaNV = @MaNV)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SQLDePendency.Properties.Settings.Default.moon_sa_QL_VATTU;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MaNV, HO, TEN, PHAI, DIACHI FROM dbo.NHANVIEN1";
        ...
        public virtual int Delete(int Original_MaNV, string Original_HO, string Original_TEN, string Original_PHAI, string Original_DIACHI) {
        ...
        public virtual int Insert(int MaNV, string HO, string TEN, string PHAI, string DIACHI) {
        ...
        public virtual int Update(int MaNV, string HO, string TEN, string PHAI, string DIACHI, int Original_MaNV, string Original_HO, string Original_TEN, string Original_PHAI, string Original_DIACHI) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string HO, string TEN, string PHAI, string DIACHI, int Original_MaNV, string Original_HO, string Original_TEN, string Original_PHAI, string Original_DIACHI) {
            return this.Update(Original_MaNV, HO, TEN, PHAI, DIACHI, Original_MaNV, Original_HO, Original_TEN, Original_PHAI, Original_DIACHI);
        }
    }
